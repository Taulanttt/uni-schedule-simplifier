...
/* convenience labels */
const ALL_YEARS      = "Të gjitha vitet";
const ALL_SEMESTERS  = "Të gjithë semestrat";
const ALL_ACADEMIC   = "Të gjithë vitet akademike";
...
const FilterPanel:React.FC<Props> = ({ filters, setFilters, compact=false }) => {
  ...
  const SelectBox:React.FC<{
    ...
    <Select value={value} onValueChange={onChange}>
      <SelectTrigger className={`h-8 ${width}`}><SelectValue placeholder={placeholder}/></SelectTrigger>
    ...
    return (
      <div className="flex gap-2 items-center">
        ...
        <SelectBox
          ...
          width="w-[140px]"
        >
          <SelectItem value="All Semesters">{ALL_ACADEMIC}</SelectItem>
        ...
        <SelectBox
          ...
          width="w-[120px]"
        >
          <SelectItem value="All Semesters">{ALL_SEMESTERS}</SelectItem>
        ...
        <SelectBox
          ...
          width="w-[110px]"
        >
          <SelectItem value="All Years">{ALL_YEARS}</SelectItem>
